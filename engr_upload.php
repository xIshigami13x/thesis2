...
if (isset($_POST['submit'])) {
  ...
  if ($fileerror1 === 0 && $fileerror2 === 0 && $fileerror3 === 0 && $fileerror4 === 0 && $fileerror5 === 0) {  

  if ($filesize1   < 20000000 && $filesize2   < 20000000 && $filesize3   < 20000000 && $filesize4   < 20000000 && $filesize5   < 20000000) {
      ...
      $query = mysqli_query($conn, "INSERT INTO engr_tb (name,filename1, filetype1, filename2, filetype2, filename3, filetype3, filename4, filetype4, filename5, filetype5, status)

       VALUES ('$name','$filename1','$filetype1' ,'$filename2','$filetype2' ,'$filename3','$filetype3' ,'$filename4', '$filetype4' ,'$filename5','$filetype5','$status')");

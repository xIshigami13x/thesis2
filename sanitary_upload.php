...
if (isset($_POST['submit'])) {
  ...
  if ($filesize1   < 20000000 OR $filesize2   < 20000000 ) {
      ...
      $filedestination = 'sanitation_pic/'.$filenamenew;
      ...
      $query = mysqli_query($conn, "INSERT INTO sanitation_tb (name, filename1, filesize1, filetype1 , filename2, filesize2, filetype2,status) VALUES ('$name', '$filename1', '$filesize1', '$filetype1', '$filename2', '$filesize2', '$filetype2','$status')");

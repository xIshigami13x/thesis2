...
<header><img src="lgu.jpg" height="8%" width="8%" class="logo">
	<h1><b>MUNICIPAL HEALTH  <br>(SANITATION) <br>
	</b></h1>
	<a href="sanitary.php" class="logout">Logout</a>
...
<form action="sanitary_upload.php"enctype="multipart/form-data" method="post">
<div class="container">
	...
	<div class="file" >
		...
		<br>
		<label>Medical Test (Employee)</label>
		<br>
		<input  type="file" id="file1"  name="file1" required>
		<br>
		<label>Water test (If the Business is Related to Water)</label>
		<br>

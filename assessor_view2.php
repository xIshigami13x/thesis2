...
<form class="container" action="assessor_board2.php" method="post">
            <?php 
            
            if (isset($_GET['id'])) {
                include("config.php");
                $id = $_GET['id'];
                $sql = "SELECT * FROM assessor_tb WHERE id=$id";
...
<div class="container">
	...
	<div class="file" >
		...
		<input type="text" class="name" disabled value="<?php echo $row["name"]; ?>" name="name" required><br><br>
		<label>* Real Property Tax(last year)</label><br>

...
<div class="dashboard">
    <div class="dashboard-item">
        <a class="bplo"  href="forms.php">Business Permit Licensing Office(Treasury)</a>
    </div>
    <div class="dashboard-item">
        <a class="zone" href="forms.php">Zoning Municipal Planning and Development office</a>
    </div>
    <div class="dashboard-item">
        <a class="permit" href="forms.php">Building Permit & Occupancy Permit Municipal Engineering Office </a>
    </div>
    <div class="dashboard-item">
        <a class="bfp" href="forms.php">Bureau of Fire Protection(BFP)</a>
    </div>
    <div class="dashboard-item">
        <a class="mao" href="assessor.php">Municipal Assessor’s Office</a>
    </div>
    <div class="dashboard-item">
        <a class="mh" href="forms.php">Municipal Health(Sanitation)</a>
    </div>
    <div class="dashboard-item">
        <a class="menro" href="forms.php">Municipal Environment and Natural Resources Officer</a>
    </div>
</div>

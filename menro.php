...
<header><img src="lgu.jpg" height="8%" width="8%" class="logo">
	<h1><b>MUNICIPAL ENVIRONMENTAL AND NATURAL RESOURCES OFFICE <br>BUSINESS PERMIT APPLICATION <br>
	</b></h1>
...
<form action="menro_upload.php"enctype="multipart/form-data" method="post">
<div class="container">
